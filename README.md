...
| 클래스명 | 역할 |
|-----------|------|
| `InputView` | 사용자로부터 당첨 번호, 보너스 번호 입력받음 |
| `OutputView` | 발행한 로또 수량 및 로또 내의 번호 출력 |
